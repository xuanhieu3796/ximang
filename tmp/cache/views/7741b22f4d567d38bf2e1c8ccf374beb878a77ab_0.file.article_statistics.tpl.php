...
/* Smarty version 4.5.5, created on 2025-04-10 22:03:41
  from 'C:\var5\ximang.local\core\plugins\Admin\templates\Dashboard\article_statistics.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.5',
  'unifunc' => 'content_67f7ddcd3d85b0_42753174',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '7741b22f4d567d38bf2e1c8ccf374beb878a77ab' => 
    array (
      0 => 'C:\\var5\\ximang.local\\core\\plugins\\Admin\\templates\\Dashboard\\article_statistics.tpl',
      1 => 1718533418,
      2 => 'file',
    ),
  ),
...
function content_67f7ddcd3d85b0_42753174 (Smarty_Internal_Template $_smarty_tpl) {
        ...
        <div class="kt-widget17__stats m-0 w-100 text-center">
            <div class="kt-widget17__items">
                <div class="kt-widget17__item cursor-default">
                    ...
                    <span class="kt-widget17__subtitle">
                        <?php echo __d('admin','tong_bai_viet');?>

                    </span>

                    <span class="kt-widget17__desc">
                        <span class="kt-font-bolder">
                            <?php if (!empty($_smarty_tpl->tpl_vars['number_article']->value)) {?>
                                <?php echo smarty_modifier_number_format($_smarty_tpl->tpl_vars['number_article']->value,0,".",",");?>
                ...
                <div class="kt-widget17__item cursor-default">
                    ...
                    <span class="kt-widget17__subtitle">
                        <?php echo __d('admin','anh');?>

                    </span>
                    
                    <span class="kt-widget17__desc">
                        <span class="kt-font-bolder">
                            <?php if (!empty($_smarty_tpl->tpl_vars['number_image']->value)) {?>
                                <?php echo smarty_modifier_number_format($_smarty_tpl->tpl_vars['number_image']->value,0,".",",");?>
            ...
            <div class="kt-widget17__items">
                <div class="kt-widget17__item cursor-default">
                    ...
                    <span class="kt-widget17__subtitle">
                        <?php echo __d('admin','video');?>

                    </span>

                    <span class="kt-widget17__desc">
                        <span class="kt-font-bolder">
                            <?php if (!empty($_smarty_tpl->tpl_vars['number_video']->value)) {?>
                                <?php echo smarty_modifier_number_format($_smarty_tpl->tpl_vars['number_video']->value,0,".",",");?>
                ...
                <div class="kt-widget17__item cursor-default">
                    ...
                    <span class="kt-widget17__subtitle">
                        <?php echo __d('admin','tai_lieu');?>

                    </span>

                    <span class="kt-widget17__desc">
                        <span class="kt-font-bolder">
                            <?php if (!empty($_smarty_tpl->tpl_vars['number_file']->value)) {?>
                                <?php echo smarty_modifier_number_format($_smarty_tpl->tpl_vars['number_file']->value,0,".",",");?>
            ...
            <div class="kt-widget17__items">                
                <div class="kt-widget17__item cursor-default">
                    ...
                    <span class="kt-widget17__subtitle">
                        <?php echo __d('admin','danh_muc_bai_viet');?>

                    </span>

                    <span class="kt-widget17__desc">
                        <span class="kt-font-bolder">
                            <?php if (!empty($_smarty_tpl->tpl_vars['number_category']->value)) {?>
                                <?php echo smarty_modifier_number_format($_smarty_tpl->tpl_vars['number_category']->value,0,".",",");?>
                ...
                <div class="kt-widget17__item cursor-default">
                    ...
                    <span class="kt-widget17__subtitle">
                        <?php echo __d('admin','bai_viet_chuan_seo');?>

                    </span>

                    <span class="kt-widget17__desc">
                        <span class="kt-font-bolder">
                            <?php if (!empty($_smarty_tpl->tpl_vars['number_article_seo']->value)) {?>
                                <?php echo smarty_modifier_number_format($_smarty_tpl->tpl_vars['number_article_seo']->value,0,".",",");?>
