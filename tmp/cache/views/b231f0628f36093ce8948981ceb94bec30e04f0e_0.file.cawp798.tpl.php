...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.5',
  'unifunc' => 'content_67f7dc460a56c2_57161191',
...
function content_67f7dc460a56c2_57161191 (Smarty_Internal_Template $_smarty_tpl) {
ob_start();
echo LANGUAGE;
$_prefixVariable63 = ob_get_clean();
if (!empty($_smarty_tpl->tpl_vars['data_extend']->value['data_collection'][$_prefixVariable63])) {?><div class="box-top-deals"><div class="title-link"><?php ob_start();
echo LANGUAGE;
$_prefixVariable64 = ob_get_clean();
if (!empty($_smarty_tpl->tpl_vars['data_extend']->value['locale'][$_prefixVariable64]['tieu_de'])) {?><h3 class="title-section"><?php echo $_smarty_tpl->tpl_vars['this']->value->Block->getLocale('tieu_de',$_smarty_tpl->tpl_vars['data_extend']->value);?>
</h3><?php }
ob_start();
echo LANGUAGE;
$_prefixVariable65 = ob_get_clean();
if (!empty($_smarty_tpl->tpl_vars['data_extend']->value['locale'][$_prefixVariable65]['link'])) {?><a href="<?php echo $_smarty_tpl->tpl_vars['this']->value->Block->getLocale('link',$_smarty_tpl->tpl_vars['data_extend']->value);?>
" class="link-right"><?php ob_start();
echo LANGUAGE;
$_prefixVariable66 = ob_get_clean();
if (!empty($_smarty_tpl->tpl_vars['data_extend']->value['locale'][$_prefixVariable66]['tieu_de_link'])) {
...
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['data_extend']->value['data_collection'][$_prefixVariable67], 'item', false, 'key');
...
$_smarty_tpl->_assignInScope('url_img', $_prefixVariable68.((string)$_smarty_tpl->tpl_vars['item']->value['logo']));
} else {
...
echo $_smarty_tpl->tpl_vars['this']->value->LazyLoad->renderImage(array('src'=>$_smarty_tpl->tpl_vars['url_img']->value,'alt'=>$_prefixVariable69,'class'=>'img-fluid'));?>
