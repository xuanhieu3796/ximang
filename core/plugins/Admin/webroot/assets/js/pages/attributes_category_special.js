...
var nhAttributesCategory = function() {
    ...
    var category = {
        ...
        loadListAttribute: function(id) {
            ...
            nhMain.callAjax({
                async: true,
                url: adminPath + '/setting/attribute/load-list-attributes/' + id,
                dataType : 'html'
        ...
        loadList: function(params = {}, page = 1) {
            ...
            nhMain.callAjax({
                async: true,
                url: adminPath + '/setting/attribute/attributes-category',
                dataType: 'html',
                data: {
                    query: params,
                    pagination: {
