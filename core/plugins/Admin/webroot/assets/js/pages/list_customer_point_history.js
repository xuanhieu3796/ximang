...
var nhListCustomerPointHistory = function() {
	var options = {
		data: {
			type: 'remote',
			source: {
				read: {
					url: adminPath + '/customer/point-history/json',
					headers: {
		...
		columns: [
			...
			},
			{
				...
				template: function(row) {
					...
					return  description_point_type + ': <span class="text-primary kt-font-bolder">'+ description_action + point + '</span>';
				}
			},
			{
				field: 'note',
...
jQuery(document).ready(function() {
	nhListCustomerPointHistory.listData();
});
