...
var nhTemplateList = {
		...
		$(document).on('click', '.nh-set-default', function() {
			...
			swal.fire({
		    	...
		    	if(typeof(result.value) != _UNDEFINED && result.value){
		    		nhMain.callAjax({
						url: adminPath + '/template/set-default',
						data:{
							id: _id
						}
	...
	export: {
		...
		event: function(){
			...
			$(document).on('click', '#btn-export-template:not(.disabled)', function(e) {
				...
				if (self.validator != null && self.validator.form()) {
					...
					nhMain.callAjax({
			            url: adminPath + '/template/export-template',
			            type: 'POST',
			            dataType: 'json',
			            data: formData,
			            contentType: false,
		...
		loadModal: function(template_id = null){
			...
			KTApp.blockPage(blockOptions);
			nhMain.callAjax({
	            url: adminPath + '/template/load-form-export-template',
	            type: 'POST',
	            dataType: 'html',
	            data:{
	...
	import: {
		...
		excuteImportTemplate: function(buttonSave = null){
			...
			nhMain.callAjax({
	            url: adminPath + '/template/import-template',
	            type: 'POST',
	            dataType: 'json',
	            data: formData,
	            contentType: false,
		...
		checkExistTemplate: function(template_code = null, callback = null){
			...
			nhMain.callAjax({
	            url: adminPath + '/template/check-exist',
	            type: 'POST',
	            dataType: 'json',
	            data: {
