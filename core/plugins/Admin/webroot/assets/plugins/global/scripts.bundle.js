    ...
    $.fn[pluginName] = function(options) {
        ...
        var Plugin = {
            ...
            init: function(options) {
                ...
                // custom data init - silv
                if(typeof(options.data_filter != 'undefined')){
                    datatable.API.params = Plugin.extendObj(datatable.API.params, 'data_filter', options.data_filter);    
                }                
