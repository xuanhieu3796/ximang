<div class="kt-subheader kt-grid__item" id="kt_subheader">
    <div class="kt-container  kt-container--fluid ">
        ...
        <div class="kt-subheader__toolbar">
            <a href="{ADMIN_PATH}/article/add" class="btn btn-sm btn-brand">
            ...
            <div class="btn-group">
                ...
                <div class="dropdown-menu dropdown-menu-right">
                    ...
                    <a class="dropdown-item" href="javascript:;" data-toggle="modal" data-target="#import-excel-modal">
                        <i class="fa fa-file-excel"></i>
                        {__d('admin', 'import_excel_binh_luan_khach_hang')}
                    </a>
                </div>
            </div>
...
<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
    <div class="kt-portlet nh-portlet">
        <div class="kt-portlet__body">
            {$this->element('../Comment/search_advanced')}
                                ...
                                <div class="btn-toolbar">
                                    <div class="dropdown mr-10">
                                        ...
                                        <div class="dropdown-menu">
                                            {foreach from = $this->ListConstantAdmin->listStatusComment() key = k_status item = status}
...
{$this->element('../Comment/modal_import_excel')}