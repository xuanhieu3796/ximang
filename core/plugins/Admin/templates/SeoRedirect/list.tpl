<div class="kt-subheader kt-grid__item" id="kt_subheader">
    <div class="kt-container  kt-container--fluid ">
        ...
        <div class="kt-subheader__toolbar">
            <a href="{ADMIN_PATH}/redirect-301/add" class="btn btn-sm btn-brand">
    ...
    <div class="kt-portlet nh-portlet">
        <div class="kt-portlet__body">
            <i class="text-danger fs-12">
                {__d('admin', 'luu_y')}:
                {__d('admin', 'vui_long_cau_hinh_chuyen_huong_{0}_truoc_khi_su_dung_chuc_nang_nay', ['301'])}. 
                <a href="{ADMIN_PATH}/redirect/setting" target="_blank">
                    <i class="fa fa-external-link-alt fs-11"></i>
                </a>
            </i>
        </div>
    </div>
