    ...
    <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <a class="form-control-static text-center kt-shape-font-color-4" href="{ADMIN_PATH}/assets/document/file_import_seeding_comment.xls" download="">
                    {__d('admin', 'tai_mau_file_excel_va_nhap_thong_tin_khach_hang')}
                ...
                <div class="kt-widget4 mt-30 mb-15">
                    <div class="kt-widget4__item">
                        ...
                        <span class="kt-widget4__title kt-widget4__title--light">
                            {__d('admin', 'khach_hang_da_chuyen_doi')}
                        </span>
