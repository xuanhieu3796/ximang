    ...
    <div id="collapse-search-advanced" class="collapse collapse-search-advanced-content">
        <div class="kt-margin-t-20">
            <div class="form-group row">
                ...
                <div nh-filter-item="city_id" class="col-md-3 d-none">
                    <div class="form-group">
                        <label>
                ...
                <div nh-filter-item="district_id" class="col-md-3 d-none">
                    <div class="form-group">
                        <label>
                ...
                <div nh-filter-item="ward_id" class="col-md-3 d-none">
                    <div class="form-group">
                        <label>
                            {__d('admin', 'phuong_xa')}
                        </label>
                ...
                <div nh-filter-item="staff_id" class="col-md-3 d-none">
                    <div class="form-group">
                        <label>
                            {__d('admin', 'nhan_vien')}
                        </label>
                ...
                <div nh-filter-item="note" class="col-md-3 d-none">
                    <div class="form-group">
                        <label>
                            {__d('admin', 'ghi_chu')}
                        </label>
