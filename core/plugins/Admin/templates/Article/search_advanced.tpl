    ...
    <div id="collapse-search-advanced" class="collapse collapse-search-advanced-content">
        <div class="kt-margin-t-20">
            <div class="form-group row">
                ...
                <div nh-filter-item="featured" class="col-md-3 d-none" >
                ...
                <div nh-filter-item="has_album" class="col-md-3 d-none">
                    <div class="form-group">
                        <label>
                            {__d('admin', 'co_album')}
                        </label>
                ...
                <div nh-filter-item="has_video" class="col-md-3 d-none">
                    <div class="form-group">
                        <label>
                            {__d('admin', 'co_video')}
                        </label>
                ...
                <div nh-filter-item="has_file" class="col-md-3 d-none">
                    <div class="form-group">
                        <label>
                ...
                <div nh-filter-item="catalogue" class="col-md-3 d-none">
                    <div class="form-group">
                        <label>
                ...
                <div nh-filter-item="seo_score" class="col-md-3 d-none">
                    <div class="form-group">
                        <label>
                            {__d('admin', 'seo')}
                        </label>
                ...
                <div nh-filter-item="keyword_score" class="col-md-3 d-none">
                    <div class="form-group">
                        <label>
                            {__d('admin', 'tu_khoa')}
                        </label>
