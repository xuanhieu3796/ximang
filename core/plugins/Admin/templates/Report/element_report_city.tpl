        ...
        <table class="table table-striped- table-bordered table-hover table-checkable dataTable no-footer dtr-inline">
            <thead class="thead-light">
                <tr>
                    ...
                    <th rowspan="2" data-field="city_id" 
                        data-sort="{if !empty($data_sort) && $data_sort eq 'asc' && $data_field eq 'city_id'}desc{else}asc{/if}" 
                        class="{if !empty($data_field) && $data_field eq 'city_id'}sorted{/if}">
            ...
            <tbody>
                {if !empty($report_order['data'])}
                    {foreach  from = $report_order['data'].item_report item = report}
                        <tr>
                            ...
                            <td>
                                {if !empty($report.city_name)}
                                    {$report.city_name}
                                {else}
                                    {__d('admin', 'nguon_chua_xac_dinh')}
                                {/if}
                            </td>
                            <td>
                ...
                {else}
                    <tr>
                        <td colspan="9">{__d('admin', 'chua_co_thong_tin')}</td>
                    </tr>
                {/if}
            </tbody>
            <tfoot>
