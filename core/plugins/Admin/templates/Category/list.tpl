<div class="kt-subheader kt-grid__item" id="kt_subheader">
    <div class="kt-container  kt-container--fluid ">
        ...
        <div class="kt-subheader__toolbar">
            <a href="{ADMIN_PATH}/category{if !empty($type)}/{$type}{/if}/add" class="btn btn-sm btn-brand">
...
<div class="d-none">
    <input id="nh-type-category" name="type" value="{$type}" type="hidden">
</div>
                    ...
                    <div class="col-xl-8 order-2 order-xl-1">
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-4 kt-margin-b-20-tablet-and-mobile">
                                <div class="kt-form__group">
                                    <div class="kt-form__control">
                                        {$this->Form->select('created_by', $this->UserAdmin->getListUser(), ['id' => 'created_by', 'empty' => "-- {__d('admin', 'nguoi_tao')} --", 'default' => '', 'class' => 'form-control form-control-sm kt-selectpicker'])}
                                    </div>
                                </div>
                            </div>                             
                        </div>
