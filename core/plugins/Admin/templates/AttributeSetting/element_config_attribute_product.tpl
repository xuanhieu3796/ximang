...
{if !empty($product_setting.categories_selected)}
    {$categories_selected = $product_setting.categories_selected}
{/if}
    ...
    <div class="kt-portlet__head px-0 pt-0 mb-20">
        <div class="kt-portlet__head-label">
            <h3 class="kt-portlet__head-title">
                {__d('admin', 'thuoc_tinh_ap_dung_theo_danh_muc_san_pham')}
            </h3>
        </div> 
    </div>
            ...
            <div class="form-group">
                ...
                <div class="kt-radio-inline mt-5">
                    <label class="kt-radio kt-radio--tick kt-radio--success mr-20">
                        <input type="radio" name="status" value="1" {if !empty($product_setting.status)}checked{/if}>
                        {__d('admin', 'dang_hoat_dong')}
                        <span></span>
                    </label>

                    <label class="kt-radio kt-radio--tick kt-radio--danger">
                        <input type="radio" name="status" value="0" {if empty($product_setting.status)}checked{/if}>
            ...
            <div class="row">
                ...
                <div class="col-xl-4 col-lg-4 border-right">
                    <div class="kt-portlet__body p-0">
                        ...
                        <div class="kt-todo__body p-0">
                            <div class="kt-todo__items" data-type="task">
                                <div id="wrap-attributes-{PRODUCT}" class="kt-scroll" data-scroll="true" data-height="530">
                ...
                <div class="col-xl-4 col-lg-4">
                    <div class="kt-portlet__body p-0">
                        ...
                        <div class="kt-todo__body p-0">
                            <div class="kt-todo__items" data-type="task">
                                <div id="wrap-options-{PRODUCT}" class="kt-scroll" data-scroll="true" data-height="530">
