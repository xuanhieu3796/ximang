        ...
        <div class="kt-portlet__head">
            <div class="kt-portlet__head-label">
                <h3 class="kt-portlet__head-title">
                    <i class="fa fa-align-justify mr-5"></i>
            ...
            <div class="kt-portlet__head-toolbar">
                <div class="kt-portlet__head-actions">
                    <a href="{ADMIN_PATH}/transform-data/export" class="btn btn-sm btn-secondary">
                        <i class="fa fa-angle-double-left"></i>
                        {__d('admin', 'quay_lai_buoc_truoc')}
                    </a>

                    {assign var = url_step_next value = "{ADMIN_PATH}/transform-data/export/categories/product"}
                    {if !empty($type) && $type == PRODUCT}
                        {assign var = url_step_next value = "{ADMIN_PATH}/transform-data/export/articles"}
                    {/if}
                    <a href="{$url_step_next}" class="btn btn-sm btn-brand">
                        {__d('admin', 'tiep_tuc')}
                ...
                <div class="col-xl-6 col-lg-8">
                    <div class="kt-widget4">
                        ...
                        <div class="kt-widget4__item">
                            ...
                            <span class="kt-widget4__number kt-font-info">
                                <span id="btn-migrate" class="btn btn-sm btn-brand {if !empty($migrate.done)}disabled{/if}" type="categories_{if !empty($type)}{$type}{/if}">
                                    <i class="fa fa-sync-alt fs-14"></i>
                    ...
                    {if !empty($migrate.done)}
                        <div class="alert alert-success mt-20 p-10" role="alert">
                            ...
                            <div class="alert-text">
                                {__d('admin', 'chuyen_doi_thanh_cong')}
                            </div>
                        </div>
                    {/if}
                </div>
