        ...
        <div class="kt-portlet__head">
            ...
            <div class="kt-portlet__head-toolbar">
                <div class="kt-portlet__head-actions">
                    <a href="{ADMIN_PATH}/transform-data/export/categories/product" class="btn btn-sm btn-secondary">
                        <i class="fa fa-angle-double-left"></i>
                        {__d('admin', 'quay_lai_buoc_truoc')}            
                    </a>

                    <a href="{ADMIN_PATH}/transform-data/export/brands" class="btn btn-sm btn-brand">
                        {__d('admin', 'tiep_tuc')}
                ...
                <div class="col-xl-6 col-lg-8">
                    <div class="kt-widget4">
                        ...
                        <div class="kt-widget4__item">
                            ...
                            <span class="kt-widget4__number kt-font-info">
                                <span id="btn-migrate" class="btn btn-sm btn-brand {if !empty($migrate.done)}disabled{/if}" type="articles">
                                    <i class="fa fa-sync-alt fs-14"></i>
