{assign var = url_list value = "{ADMIN_PATH}/district/{$city_id}"}
{assign var = url_add value = "{ADMIN_PATH}/district/add/{$city_id}"}
{assign var = url_edit value = "{ADMIN_PATH}/district/update/{$city_id}"}
...
<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
    <form id="main-form" action="{ADMIN_PATH}/district/save{if !empty($id)}/{$id}{/if}" method="POST" autocomplete="off">
                ...
                <div class="row">
                    <div class="col-xl-6 col-lg-6">
                        <div class="form-group">
                            <label>
                                {__d('admin', 'ten_quan_huyen')}
                                 <span class="kt-font-danger">*</span>
                            </label>
                            <input name="name" value="{if !empty($district.name)}{$district.name|escape}{/if}" class="form-control form-control-sm" type="text" maxlength="255">
                        </div>   
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-xl-2 col-lg-3">
                        <div class="form-group">
                            ...
                            <input name="position" value="{if !empty($district.position)}{$district.position}{/if}" class="form-control form-control-sm" type="text">
                        </div>
                    </div>
                </div>
            </div>
