        ...
        <div class="kt-section kt-section--first">
            <div class="kt-section__body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9 col-xl-6">
                        <input class="form-control" type="text" disabled="disabled" placeholder="{if !empty($user.username)}{$user.username}{/if}">
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-xl-3 col-lg-3 col-form-label">
                    ...
                    <div class="col-lg-9 col-xl-6">
                        <input class="form-control" disabled="disabled" type="text" placeholder="{if !empty($user.email)}{$user.email}{/if}">
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-xl-3 col-lg-3 col-form-label">
                    ...
                    <div class="col-lg-9 col-xl-6">
                        <input class="form-control" disabled="disabled" type="text" placeholder="{if !empty($user.role_name)}{$user.role_name}{/if}">
                    </div>
                </div>
            </div>
        </div>
