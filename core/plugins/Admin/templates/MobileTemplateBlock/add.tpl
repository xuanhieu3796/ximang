...
<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
    <form id="main-form" action="{ADMIN_PATH}/mobile-app/block/create" method="POST" autocomplete="off">
                ...
                <div class="row">
                    <div class="col-lg-6 col-12">
                        <div class="form-group">
                            ...
                            {$this->Form->select('type', $this->MobileTemplateAdmin->getTypeMobileBlockForDropdown(), ['id' => 'type', 'empty' => "{__d('admin', 'chon')}", 'default' => null, 'class' => 'form-control form-control-sm kt-selectpicker'])}
                        </div>
