    ...
    <div class="kt-container  kt-container--fluid ">
        ...
        <div class="kt-subheader__toolbar">
            ...
            {if !empty(CODE_TEMPLATE)}
                <a href="{ADMIN_PATH}/mobile-app/block/add" class="btn btn-sm btn-brand">
                                ...
                                <div class="col-md-4 kt-margin-b-20-tablet-and-mobile">
                                    <div class="kt-form__group">
                                        <div class="kt-form__control">
                                            {$this->Form->select('type', $this->MobileTemplateAdmin->getTypeMobileBlockForDropdown(), ['id'=>'type', 'empty' => {__d('admin', 'loai_block')}, 'default' => '', 'class' => 'form-control form-control-sm kt-selectpicker'])}
                                        </div>
                                    </div>
                                </div>
