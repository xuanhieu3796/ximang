<div class="kt-portlet nh-portlet">
    ...
    <div class="kt-portlet__body">
        <form nh-form ="form" action="{ADMIN_PATH}/mobile-app/block/save-data-config{if !empty($code)}/{$code}{/if}" method="POST" autocomplete="off">
            <div class="row">
    ...
    <div class="kt-portlet__body">
        <form action="{ADMIN_PATH}/mobile-app/block/save-layout-config{if !empty($code)}/{$code}{/if}" method="POST" autocomplete="off">
            ...
            <div class="row">
                ...
                {* <a href="action://form?params=138"></a> *}
