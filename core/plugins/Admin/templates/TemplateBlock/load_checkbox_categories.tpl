            ...
            {foreach from = $list_categories key = category_id item = category}
                ...
                <div class="clearfix">
                    ...
                    <label class="kt-checkbox kt-checkbox--tick kt-checkbox--success mb-5">
                        <input name="" data-name="sub_categories_id" data-mutiple="true" value="{$category_id}" {if !empty($categories_selected) && $category_id|in_array:$categories_selected}checked{/if} type="checkbox"> 
