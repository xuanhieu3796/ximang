<div class="kt-subheader kt-grid__item" id="kt_subheader">
    <div class="kt-container  kt-container--fluid ">
        ...
        <div class="kt-subheader__toolbar">
            <a href="{ADMIN_PATH}/template/dashboard" class="btn btn-sm btn-secondary">
                {__d('admin', 'quay_lai')}
            </a>
        </div>
    </div>
                ...
                <div class="col-xl-3 col-md-4 col-12">
                    <div class="kt-portlet kt-portlet--height-fluid kt-ribbon kt-ribbon--success kt-ribbon--shadow kt-ribbon--left">
                        ...
                        <div class="nh-screenshot">
                            <img {if empty($item.is_default) && $item.is_default != 1}class="bg-inactive"{/if} src="/templates/{if !empty($item.code)}{$item.code}{/if}/screenshot.png">
