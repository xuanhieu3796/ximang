<form id="nowpayment-form" action="{ADMIN_PATH}/setting/payment-gateway/{NOWPAYMENT}" method="POST" autocomplete="off">
    ...
    <div class="form-group">
        ...
        <span>
            {$this->Utilities->getUrlWebsite()}/payment/webhooks/nowpayment
        </span>
    </div>
</form>