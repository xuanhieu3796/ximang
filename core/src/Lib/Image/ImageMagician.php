...
## --------------------------------------------------------
    ...
    public function saveImage($savePath, $imageQuality="100")    
    {
        ...
        if (!is_resource($this->imageResized) && !$this->imageResized instanceof \GdImage) { if ($this->debug) { die('saveImage: This is not a resource.'); }else{ die(); }}
