	...
	<article class="article-detail">
        <div class="row">
            {if !empty($article_info.catalogue)}
                <div class="col-12 col-xl-3 box-catalogue">
                    <div class="sticky-top box-content-article" nh-table-content="wrap"></div>
                </div>
            {/if}
            
            <div class="col-12 {if !empty($article_info.catalogue)}col-xl-9{else}col-xl-12{/if}">
