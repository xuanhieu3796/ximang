...
{if !empty($pages) && $pages > 1}
    <ul class="pagination justify-content-center">
        {if !empty($show_first)}
            <li class="page-item">
                <a class="page-link" href="javascript:;" nh-page-redirect="1" title="{__d('template', 'trang_dau_tien')}">
        ...
        {if $pages > $show_max_page && $page > 1}
            <li class="page-item">
                <a class="page-link" href="javascript:;" nh-page-redirect="{$page - 1}" title="{__d('template', 'trang_truoc')}">
        ...
        {for $number = $start to $end}
            ...
            {else}
                <li class="page-item">
                    <a class="page-link" href="javascript:;" nh-page-redirect="{$number}">
                        {$number}
                    </a>
                </li>
            {/if}
        ...
        {if $pages > $show_max_page && $page < $pages}
            <li class="page-item">
                <a class="page-link" href="javascript:;" nh-page-redirect="{$page + 1}" title="{__d('template', 'trang_tiep')}">
        ...
        {if !empty($show_last)}
            <li class="page-item">
                <a class="page-link" href="javascript:;" nh-page-redirect="{$pages}" title="{__d('template', 'trang_cuoi')}">
