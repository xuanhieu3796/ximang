...
<div class="product-attribute-switch d-flex justify-content-start text-switch flex-wrap mb-5">
    <a href="javascript:;" nh-link-redirect="{$this->Utilities->addParamsToUrl($current_url, ["{$filter_type}{$code}" => '13/5/2022_lt'])}" nh-link-toggle="{$this->Utilities->toggleValueParamsToUrl($current_url, "{$filter_type}{$code}", '13/5/2022_lt')}" class="inner-product-attribute">
        13/5/2022
    </a>
</div>